...
> 22.1. Q22.1. 品牌清算专户余额和清算中金额分别是怎么计算的？业务上是什么关系？
>
> **分账与付款（签约授权）**
...
| 常见问题、FAQ、品牌清算专户余额、清算中金额、入驻资料、商户编码删除、清算流程、手续费、扣保退保、POS绑定、资金归集、每日检查 | [faq.md](references/faq.md) | 35 个常见问题标准答案，覆盖入驻、订单、账户、清算、签约、提现、综合问题 |
